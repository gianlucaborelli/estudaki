...
public class ExamProcessingMetadataRepository2 : BaseRepository<ExamProcessingMetadata>, IExamProcessingMetadataRepository
{
    public ExamProcessingMetadataRepository2(IMongoContext context) : base(context)
    {
    }
